namespace Mp3YtubeDownloader
{
    ...
    {
		public static readonly string DefaultInitialDirectory = "/storage";
        private FileListAdapter _adapter;
        private DirectoryInfo _directory;

		public static string SelectedDirctory { get; set; }
        ...
        public void RefreshFilesList(string directory)
        {
			...
			SelectedDirctory = directory;
			var prevDir = dir;;
			if (directory != DefaultInitialDirectory)
				prevDir = dir.Parent;
			visibleThings.Insert(0, prevDir);
            try
            {
